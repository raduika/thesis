...
Značná část jeho empirických opor je totiž v odborné literatuře sporná: metaanalýzy vlivu digitálních médií na duševní pohodu nacházejí efekty řádově zanedbatelné \parencite{OrbenPrzybylski19}; teze o filtračních bublinách je empiricky opakovaně zpochybňována \parencite{Bruns19,Guess23};
 přesvědčovací účinnost psychografického mikrotargetingu je pravděpodobně podstatně nižší, než se po kauze Cambridge Analytica soudilo \parencite{SimchonEdwardsLewandowsky24}. Vzniká tak nepříjemná otázka: kdyby se ukázalo, že digitální prostředí polarizuje méně, než se předpokládá, a že jeho vliv na kognitivní schopnosti je zanedbatelný — ztratila by kritika algoritmické moci svůj předmět?
...
Metodou práce je pojmová analýza a kritická rekonstrukce, provozovaná v tradici kritické teorie technologie \parencite{Feenberg02} a politické epistemologie \parencite{Coeckelbergh23}.
