...
Politický význam tohoto vyloučení nespočívá v tom, že by stroje \uv{nemyslely} (spor o to nechávám otevřený), nýbrž v tom, že takto zúžený pojem rozumu učinil myslitelným delegování rozhodnutí na entitu, jež nesplňuje podmínky odpovědného subjektu.
...
Za třetí, a to je hlavní teze práce: politické bezpráví algoritmické moci nespočívá ve škodě, nýbrž v nadvládě.
...
V republikánském pojetí svobody jako nepřítomnosti nadvlády je toto bezpráví plné a nezávislé na tom, zda je moc uplatňována laskavě.
Právě tento posun umožňuje vysvětlit, proč individualisticky pojatá ochrana práv — souhlas, přístup k datům, právo na vysvětlení — strukturálně selhává: nadvláda je vztah, nikoli událost, a nelze ji odstranit ani sebedokonalejším informovaným souhlasem jednotlivce.
...
A konečně zmocnění: budování alternativní, federativní a společně vlastněné digitální infrastruktury, jež logiku nadvlády nereprodukuje.
...
Přijímá habermasovský normativní rámec, ačkoli ten je sám předmětem sporu — agonistická kritika \parencite{Mouffe13} by namítla, že ideál racionálního konsensu depolitizuje stejně účinně jako technokracie, proti níž je namířen;
